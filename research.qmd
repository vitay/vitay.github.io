...
### [Oceanic currents forecast](research/currentforecast.qmd)

::: {.columns}
::: {.column width=70%}

Conditional diffusion models can forecast high-resolution ocean surface currents using historical current data and wind forecasts. The model maintains stability over 10-day autoregressive forecasts and provides uncertainty quantification for operational decision-making in applications like oil spill response.
